...
fn main() {
    println!("Running wew cookie tests...");
    
    // Run all test functions
    test_cookie_creation();
    test_cookie_default();
    test_cookie_builder();
    test_cookie_expiration_timestamp();
    test_cookie_expiration_duration();
    test_same_site_values();
    test_priority_values();
    test_cookie_error_display();
    test_cookie_builder_chaining();
    test_cookie_with_empty_strings();
    test_cookie_clone();
    test_cookie_debug_format();
    test_error_equality();
    test_multiple_domain_cookies();
    test_session_vs_persistent_cookies();
    test_cookie_attributes_combinations();
